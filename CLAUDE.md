...
- **Frontend:** Vanilla JS, no framework. `v2/` directory is currently active.
...
4. **`v2/` is the active frontend; `v3/` is a half-done fork scheduled for deletion.** Do not change `v3/`. Do not mirror `v2/` changes into `v3/`.
