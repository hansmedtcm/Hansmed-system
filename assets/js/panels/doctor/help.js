...
(function () {
  ...
  function render(el) {
    el.innerHTML = '<div class="page-header">' +
      ...
      card('💰', 'Salary &amp; Pay', '薪資', 'Doctors are paid by monthly salary from the clinic. The Consultation Log shows fees collected on your behalf for reference. Salary questions: contact the clinic admin office.') +
